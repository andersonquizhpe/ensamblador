...
section .data
    ...
    mensaje_suma db 10,"El resultado de la suma es: "
    len_mensaje_suma equ $-mensaje_suma
    
    mensaje_resta db 10,"El resultado de la resta es: "
    len_mensaje_resta equ $-mensaje_resta
    
    mensaje_mult db 10,"El resultado de la multiplicacion es: "
    len_mensaje_multiplicacion equ $-mensaje_mult
    
    mensaje_division db 10,"El resultado de la division es: "
